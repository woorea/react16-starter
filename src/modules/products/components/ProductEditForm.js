...
import DatePicker from 'components/TextArea'
  
export default reduxForm({})(({onCancel: handleCancel, handleSubmit}) => {
    return (
        <Form onSubmit={handleSubmit}>
            <Field id="product-code" label="Code" name="code" component={InputText} disabled />
            ...
            <Form.Item>
                ...
                &nbsp;
                <Button icon="save" onClick={handleSubmit} htmlType="submit">Update</Button>
            </Form.Item>
        </Form>
    )
})